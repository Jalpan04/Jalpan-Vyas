const portfolioData = {
    "projectData": [
        ...
        },
        {
            ...
            "tagline": "Generate text in the 'Brat' album aesthetic.",
            "description": "A simple web application that generates text in the style of Charli XCX's \"Brat\" album aesthetic. It features a generator for the iconic blurred 'Brat' style, theme toggling, and the ability to save the generated image.",
            "image": "https://github.com/user-attachments/assets/cbd66b4a-1464-4c64-8322-5e0535f79987",
        ...
        },
        {
            "id": "identity",
            "name": "identity",
            "tagline": "A modern Windows desktop app for organizing personal interests.",
            "description": "!dentity is a Windows Forms application designed to help users catalog and manage their personal interests in an intuitive, user-friendly interface. Built with C# and .NET Framework 4.8, the app features tracking for books, movies, music, and travel plans, showcasing strong object-oriented design.",
            "image": "https://github.com/Jalpan04/identity/raw/main/assets/dashboard.png",
        ...
        },
        {
            ...
            "tagline": "An in-depth exploratory data analysis of personal Spotify streaming history.",
            "description": "This project provides an in-depth exploratory data analysis (EDA) of personal Spotify streaming history data. The analysis is conducted using Python with data manipulation and visualization libraries suchs as Pandas, Matplotlib, and Seaborn to uncover listening patterns and visualize trends over time.",
            "image": "assets/images/personal-spotify-eda.png",
            "sourceUrl": "https://github.com/Jalpan04/personal-spotify-EDA",
            "tech": [
                "Jupyter Notebook",
                "Python"
            ]
        ...
        {
            "id": "seedhe-maut-data",
            "name": "seedhe_maut_data",
            "tagline": "A comprehensive database of lyrics from the Indian hip-hop duo Seedhe Maut.",
            "description": "This repository contains a database of lyrics from the albums of Seedhe Maut. The lyrics were scraped from Genius using the `lyricsgenius` Python library and have been compiled into a structured dataset, available as a CSV file and individual text files.",
            "image": "assets/images/seedhe-maut-data.jpg",
            "sourceUrl": "https://github.com/Jalpan04/seedhe_maut_data",
            "tech": [
                "Jupyter Notebook",
                "Python"
            ]
    ...
    "allShortcutPages": [
        ...
        },
        {
            "id": "linkedin",
            "title": "LinkedIn",
            "url": "https://www.linkedin.com/in/jalpan-vyas/",
